...
<html lang="en" data-theme="light" data-layout="topnav" data-topbar-color="dark" data-layout-mode="fluid" data-layout-position="fixed">
 <head>
        <meta charset="utf-8" />
        <title> Alumni Admin | Request </title>
                                ...
                                <div class="card mt-4">
                                    <div class="card-body">
                                        <%
                                            ...
                                            ArrayList<UserModel> model = user.findAllByRequest(1);
                                        %>

                                        <table id="selection-datatable" class="table dt-responsive nowrap w-100">
                                            <h3 style="text-align: center"> Request Table for Alumni</h3>
                                            <thead>
                                                <tr>
                                                    <th>Sr No.</th>
                                                    <th>Name</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="AlumniController?action=requestApprove&id=<%= use.getUserId()%>&page=alumni" class="action-icon btn btn-success text-white">Approve</a>
                                                    </td>
                                                    <td>
