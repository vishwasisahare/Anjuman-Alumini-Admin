                                        ...
                                        <div class="tab-content">
                                            <div class="">
                                                <%
                                                    ...
                                                    ArrayList<UserModel> model = user.findAllByAlumni();
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="AlumniController?action=delete&id=<%= add.getUserId()%>&page=alumni" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item')" ><i class="mdi mdi-delete"></i></a> 
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                    <%}%>
