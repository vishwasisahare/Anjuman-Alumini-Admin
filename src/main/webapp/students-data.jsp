...
<html lang="en" data-theme="light" data-layout="topnav" data-topbar-color="dark" data-layout-mode="fluid" data-layout-position="fixed">
    <head>
        <meta charset="utf-8" />
        <title> Alumni Admin | Students </title>
                                        ...
                                        <div class="tab-content">
                                            <div class="">
                                                <%  UserController user = new UserController();
                                                    ArrayList<UserModel> model = user.findAllByUserType("student");
                                                %>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="AlumniController?action=delete&id=<%= add.getUserId()%>&page=student" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item')" ><i class="mdi mdi-delete"></i></a> 
                                                                </td>
